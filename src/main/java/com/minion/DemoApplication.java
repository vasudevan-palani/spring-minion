	...
	private void readInvoice(File file) throws NumberFormatException, ParseException {
		...
		try {
			...
			if (true) {
				...
				// + vals.get("INVOICE DATE") + "#" + vals.get("CREDIT NOTE
				// DATE") + "#"
				// + vals.get("CREDIT NOTE NUMBER") + "#" + vals.get("ORIGINAL
				// INVOICE") + "#"
				...
				// System.out.println("INVOICE : "+vals.get("INVOICE"));
				// System.out.println("INVOICE NUMBER : "+vals.get("INVOICE
				// NUMBER"));
				// System.out.println("INVOICE DATE : "+ vals.get("INVOICE
				// DATE"));
				// System.out.println("CREDIT NOTE DATE : "+vals.get("CREDIT
				// NOTE DATE"));
				// System.out.println("CREDIT NOTE NUMBER : "+ vals.get("CREDIT
				// NOTE NUMBER"));
				// System.out.println("ORIGINAL INVOICE : "+vals.get("ORIGINAL
				// INVOICE"));
				// System.out.println("PROJECT ID : "+vals.get("PROJECT ID"));
				// System.out.println("PROJECT NAME : "+ vals.get("PROJECT
				// NAME"));
				// System.out.println("BILLING_FROM :
				// "+vals.get("BILLING_FROM"));
